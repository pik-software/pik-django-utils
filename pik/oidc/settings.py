...
def _to_list(sequence, name):
    ...
    Traceback (most recent call last):
        ...
    pik.oidc.settings.UnknownSequenceType: Unknown sequence type \
...
def _append(settings, name, value):
    ...
    Traceback (most recent call last):
        ...
    pik.oidc.settings.SequenceItemAlreadyDefined: Sequence c value is \
...
def _prepend(settings, name, value):
    ...
    Traceback (most recent call last):
        ...
    pik.oidc.settings.SequenceItemAlreadyDefined: Sequence c value \
...
def _insert(settings, name, after, value):
    ...
    Traceback (most recent call last):
        ...
    pik.oidc.settings.RequiredSequenceItemMissing: Required item c \
missing form setting TEST
    ...
    Traceback (most recent call last):
        ...
    pik.oidc.settings.SequenceItemAlreadyDefined: Sequence item b \
is already defined in setting TEST
    ...
    try:
        ...
        raise RequiredSequenceItemMissing(
            f'Required item {after} missing form setting {name}') from exc
...
def _check_settings(settings):
    ...
    Traceback (most recent call last):
        ...
    pik.oidc.settings.RequiredSettingMissing: Explicit \
settings.INSTALLED_APPS definition required

    >>> _check_settings({'INSTALLED_APPS': [], 'AUTHENTICATION_BACKENDS': [],
    ...                  'MIDDLEWARE': [], 'SOCIAL_AUTH_PIPELINE': []})
    Traceback (most recent call last):
        ...
    pik.oidc.settings.ConflictSetting: Setting SOCIAL_AUTH_PIPELINE have to \
be defined by set_oidc_settings() only
...
def set_oidc_settings(settings):
    ...
    _insert(settings, 'MIDDLEWARE',
            'django.contrib.sessions.middleware.SessionMiddleware',
            'pik.oidc.middleware.OIDCDefaultBackendMiddleware')
    ...
    settings.setdefault('SOCIAL_AUTH_JSONFIELD_ENABLED', True)
